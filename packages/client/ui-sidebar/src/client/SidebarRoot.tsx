            ...
            <span className={css.brandIdentity} aria-hidden="true">
              <span className={css.brandMark}>
                {renderSlot('sidebar.brand.mark', { size: 24 }, {
                  fallback: <img src="/kalix-code-mascot.png" alt="" width={24} height={24} />,
                })}
              </span>
              <span className={css.brandName}>
                {renderSlot('sidebar.brand.name', {}, {
                  fallback: (
                    <>
                      <span className={css.fallbackBrandName}>Kalix Code</span>
                      {(process.env.KALIX_CLIENT_COMMIT_HASH ?? process.env.DSH_CLIENT_COMMIT_HASH)
                        ? <span className={css.buildRevision}>{process.env.KALIX_CLIENT_COMMIT_HASH ?? process.env.DSH_CLIENT_COMMIT_HASH}</span>
                        : null}
                    </>
                  ),
                })}
