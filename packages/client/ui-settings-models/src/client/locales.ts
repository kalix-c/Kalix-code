...
export const en = {
  ...
  customNeedsDisplayName: 'Enter a display name for this provider.',
  customNeedsBaseUrl: 'A custom provider needs a base URL.',
  customInvalidBaseUrl: 'Use a complete HTTP or HTTPS base URL.',
  customNeedsModels: 'No models were found yet. Check the URL and API key, or add a model by hand.',
  customDiscoveringModels: 'Fetching available models automatically…',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  customApi: 'API 协议',
  customApiUnset: '未选择',
  customNeedsDisplayName: '请填写这个提供方的显示名称。',
  customNeedsBaseUrl: '自定义提供方需要填写 API 地址。',
  customInvalidBaseUrl: '请使用完整的 HTTP 或 HTTPS API 地址。',
  customNeedsModels: '尚未找到模型。请检查 API 地址和密钥，或手动添加模型。',
  customDiscoveringModels: '正在自动获取可用模型…',
  create: '创建提供方',
  creating: '创建中\u2026',
